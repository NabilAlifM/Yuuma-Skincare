...
export default function StoryPage() {
    ...
    <div className="pt-20">
      ...
      <section className="bg-cream-beige/30 py-32 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 space-y-8">
          <motion.p 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="text-[12px] uppercase tracking-[0.3em] font-bold text-nude-pink"
          >
            The Beginning
          </motion.p>
          <motion.h1 
            ...
            className="text-5xl md:text-7xl font-serif text-deep-brown leading-tight"
          >
            Yuuma lahir dari <br />
          ...
          <motion.div 
            ...
            className="h-px w-24 bg-deep-brown mx-auto"
          />
        </div>
      </section>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
        <motion.div {...FADE_IN} className="flex-1">
          <div className="rounded-[40px] overflow-hidden shadow-2xl relative group">
            ...
            />
            <div className="absolute inset-0 bg-deep-brown/10"></div>
          </div>
        </motion.div>
        
        <motion.div {...FADE_IN} className="flex-1 space-y-8">
          <h2 className="text-4xl font-serif text-deep-brown leading-snug">
            Bukan sekadar skincare, melainkan perawatan berkelanjutan.
          </h2>
          <div className="space-y-6 text-deep-brown/70 leading-relaxed text-lg font-light">
            <p>
            ...
            <p className="font-serif italic text-deep-brown font-medium text-2xl">
      ...
      {/* Three Pillars */}
      <section className="bg-cream-beige py-32 px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            {[
              ...
              <motion.div 
                ...
                className="space-y-6 md:border-l border-deep-brown/10 md:pl-8"
              >
                <span className="text-5xl font-serif italic text-nude-pink opacity-50 block">{pillar.num}</span>
                <h3 className="text-2xl font-serif text-deep-brown font-semibold">{pillar.title}</h3>
                <p className="text-deep-brown/70 leading-relaxed">{pillar.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          {[
            ...
            >
              <div className="flex-shrink-0 w-24 text-right">
                <span className="text-3xl font-serif italic text-sage-green font-bold">{item.year}</span>
              </div>
              <div className="relative flex-grow pb-8 border-l-2 border-sage-green/20 pl-12">
                <div className="absolute top-2 -left-[9px] w-4 h-4 rounded-full bg-sage-green shadow-soft"></div>
                <h4 className="text-xl font-serif font-bold text-deep-brown mb-2">{item.event}</h4>
                <p className="text-deep-brown/60 leading-relaxed">{item.detail}</p>
              </div>
            </motion.div>
          ))}
        </div>
      ...
      {/* Closing Banner */}
      <section className="bg-nude-pink py-24 px-6 text-center text-warm-white">
